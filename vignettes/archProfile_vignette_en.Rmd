...
- *view*: There are two possibilities for the transformation of data. 

   In the *surface* option, the points are processed for an orthogonal view on the profile. 

   In the *projected* case, the data is transformed for a view on a vertical sectional pane (like a traditional drwaing on an excavation). Standart: *surface*

- *direction*: The position of the fgc in relation to the profile.

   The *original* option exports the data (nearly) parallel to the cutting line. 

   *horizontal* will show the profile parallel to the x-axis (internal differences in height are still present). Standart: *horizontal*
...
###Step one: Rotating on the z-axis
