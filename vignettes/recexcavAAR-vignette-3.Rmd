...
1. the local x-value (east-value)
>>>>>>> eb7d2ecec33bb6bb2904d19674476f4181eb2e6f
...
The *cootrans-*function returns the original data.frame with two additional columns with the calculated projected coordinates. 
