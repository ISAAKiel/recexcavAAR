...
vis <- vis %>% 
  add_trace(
    ...
    hoverinfo = "text",
    text = paste(
      "SING: ", "inv = ", vesselsingle$inv, "; spit = ", vesselsingle$spit ,"; 
      square = ", vesselsingle$square, "; feature = ", vesselsingle$feature,
      sep = ""
    )
  )
...
vis %>%
  add_trace(
    ...
    hoverinfo = "text",
    text = paste(
      "MASS: ", "inv = ", vesselm$inv, "; spit = ", vesselm$spit ,
      "; square = ", vesselm$square, "; feature = ", vesselm$feature,
      sep = ""
    )
  )
```